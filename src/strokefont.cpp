...
char *StrokeFont::fontVertexShader = R"XX(
...
char *StrokeFont::fontFragmentShader = R"XX(
...
void StrokeFont::drawStrokeString( string str, float x, float y, float height, float theta, Alignment alignment )
